...
SOURCE_DIR = Path("datasets/processed/maize_extended/train")
OUTPUT_DIR = Path("datasets/processed/maize_extended_balanced/train")
...
def main():
    ...
    print("=" * 70)
    print("AGRIMIND AI - MAIZE BALANCED AUGMENTATION")
    print("=" * 70)
