...
export default function DiseaseDetection() {
    ...
    const ui = {
        en: {
            ...
            tipsList: "Use a clear, well-lit image  •  Keep the entire leaf visible  •  Avoid blurry images  •  Select the correct crop type",
            tipsQuote: '"Early detection leads to better yields."',
    ...
    const rawSelectedCropKey = (routeCrop || storageCrop || "soybean").toLowerCase();

    const selectedCropKey =
        rawSelectedCropKey === "tur"
            ? "pigeon_pea"
            : rawSelectedCropKey;

    const supportedCrops = ["soybean", "cotton", "maize", "wheat", "pigeon_pea"];
    ...
    const cropDisplayName =
        ...
        selectedCropKey === "wheat" ? "Wheat" :
        selectedCropKey === "pigeon_pea" ? "Tur (Pigeon Pea)" : "Soybean";
    ...
    // Helper to render complete guidance content inside table cells
    const renderGuidanceContent = (content) => {
        if (!content || (Array.isArray(content) && content.length === 0)) {
            return <span style={{ color: "#94a3b8", fontStyle: "italic", fontSize: "13px" }}>No specific guidance indicated for this condition.</span>;
        }
        if (Array.isArray(content)) {
            if (content.length === 1 && typeof content[0] === "string" && !content[0].includes("\n") && !content[0].match(/^[-*•]\s+/)) {
                return <div className="exp-table-guidance-text">{renderFormattedText(content[0])}</div>;
            }
            return (
                <ul className="exp-table-guidance-list">
        ...
        return <div className="exp-table-guidance-text">{renderFormattedText(content)}</div>;
    };
    ...
    return (
        <div className="exp-disease-detection-page">
            <style>{`
                ...
                /* Advisory Table (Plant Care & Management Raw Table) */
                .exp5-plant-care {
                    margin-bottom: 24px;
                }

                .exp-care-table-wrapper {
                    width: 100%;
                    background: #ffffff;
                    border-radius: 16px;
                    border: 1px solid #e2e8f0;
                ...
                .exp-care-table tbody tr {
                    border-bottom: 1px solid #f1f5f9;
                    transition: background-color 0.15s ease;
                }

                .exp-care-table tbody tr:last-child {
                    border-bottom: none;
                }

                .exp-care-table tbody tr:hover {
                ...
                .exp-table-guidance-list li {
                    margin-bottom: 8px;
                }

                .exp-table-guidance-list li:last-child {
                    margin-bottom: 0;
                }

                .exp-table-guidance-text {
                    color: #334155;
                    font-size: 13.5px;
                    line-height: 1.65;
                }
            ...
            <div className="detection-hero-card">
                ...
                <div className="hero-right-actions">
                    <div className="crop-status-pill">
                        ...
                        <span>{cropDisplayName} ✨ {text.aiReady}</span>
                    </div>
            ...
            {predictionResult && (
                <div className="results-container-card">
                    ...
                    <div className="result-top-summary">
                        <div className="result-headline">
                            ...
                            <div className="result-titles">
                                ...
                                <span>{cropDisplayName} ✨ {text.completed || "Analysis complete"}</span>
                            </div>
                        </div>
                    ...
                    <div className="exp-verify-warning-box">
                        ...
                        <div>
                            <strong>⚠️ Please verify this result in the field</strong>
                    ...
                    {recommendationLoading ? (
                        ...
                        <div className="exp5-plant-care">
                            ...
                            <div className="exp-care-table-wrapper">
                                <table className="exp-care-table">
                                    <thead>
                                        <tr>
                                            <th className="exp-care-th-area">Management Area</th>
                                            <th className="exp-care-th-guidance">Guidance & Recommendations</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {/* 1. Symptoms */}
                                        <tr>
                                            <td className="exp-care-td-area">
                                                <span className="exp-care-area-badge">{text.symptoms || "Symptoms"}</span>
                                            </td>
                                            <td className="exp-care-td-guidance">
                                                {renderGuidanceContent(recommendation.symptoms)}
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td className="exp-care-td-area">
                                                <span className="exp-care-area-badge">{text.immediateAction || "Immediate Action"}</span>
                                            </td>
                                            <td className="exp-care-td-guidance">
                                                {renderGuidanceContent(recommendation.immediate_action)}
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td className="exp-care-td-area">
                                                <span className="exp-care-area-badge">{text.sprayGuidance || "Spray Guidance"}</span>
                                            </td>
                                            <td className="exp-care-td-guidance">
                                                {renderGuidanceContent(recommendation.spray_guidance)}
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td className="exp-care-td-area">
                                                <span className="exp-care-area-badge">{text.prevention || "Prevention"}</span>
                                            </td>
                                            <td className="exp-care-td-guidance">
                                                {renderGuidanceContent(recommendation.prevention)}
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td className="exp-care-td-area">
                                                <span className="exp-care-area-badge">{text.treatment || "Treatment Guidance"}</span>
                                            </td>
                                            <td className="exp-care-td-guidance">
                                                {renderGuidanceContent(recommendation.treatment || recommendation.treatment_guidance)}
                                            </td>
                                        </tr>

                                        {/* 6. Farmer Action Recommendation */}
                                        <tr>
                                            <td className="exp-care-td-area">
                                                <span className="exp-care-area-badge">Farmer Action Recommendation</span>
                                            </td>
                                            <td className="exp-care-td-guidance">
                                                {renderGuidanceContent(recommendation.farmer_action || recommendation.farmer_action_recommendation)}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
